...
public interface ShoppingCartDAO {
    ...
    /**
     * When given a {@linkplain Customer customer}'s username and the desired {@link Product
     ...
     * 
     * @param username the username of the {@link Customer customer} that is adding a
     ...
     */
    Product addProduct(String username, int id, int amount) throws IOException;

    /**
     * Deletes a {@linkplain Product product} within the specified {@link Customer
     * customer}'s {@link ShoppingCart shopping cart}
     * 
     * @param username the username of the {@link Customer customer} that is deleting a
     *                 {@link Product product}
     ...
     * 
     * @param username the username of the {@link Customer customer} that is invoking this method
     * 
     ...
     * cart}
     * 
     * @param username the username of the {@link Customer customer} that wishes to clear their
     *                 {@link ShoppingCart shopping cart}
     * 
     ...
     * 
     * @param username the username of the {@link Customer customer} that wishes to checkout
     *                 
